"""
Django settings for withered_term_43458 project.
...
ROOT_URLCONF = 'withered_term_43458.urls'
...
WSGI_APPLICATION = 'withered_term_43458.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_term_43458 API",
    "DESCRIPTION": "API documentation for withered_term_43458 App",
    "VERSION": "v1",
}
